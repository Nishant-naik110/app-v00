...
// API Base URL
const REPORT_API_BASE = process.env.NEXT_PUBLIC_APP_PERF + "reporting_tool/integrity";
...
export const useGetCategories = (
  ...
  return useApi<CategoryOption[]>(
    ...
    {
      queryKey: ["integrity-report-categories", packageName || ""] as const,
      enabled,
    }
  );
};
...
export const useGetTemplates = (
  ...
  return useApi<string[]>(
    ...
    {
      queryKey: ["integrity-report-templates", packageName || "", category || ""] as const,
      enabled,
    }
  );
};
...
export const useGetTemplateFields = (
  ...
  return useApi<TemplateFieldsResponse>(
    ...
    {
      queryKey: ["integrity-template-fields", template || "", category || "", packageName || "", reportType || ""] as const,
      enabled,
      staleTime: 0,
      cacheTime: 0,
    }
...
export const useGetDimensionFilters = (
  ...
  return useApi<FilterResponse>(
    ...
    {
      queryKey: ["integrity-dimension-filters", dimensionId || "", packageName || "", categoryParam, reportType || "", search || ""] as const,
      enabled,
    }
  );
};
...
export const useCreateReport = (
  ...
  return useApi<CreateReportResponse>(
    ...
    payload,
    {
      queryKey: ["integrity-create-report", payload ? JSON.stringify(payload) : ""] as const,
      enabled,
    }
  );
};
...
export const useViewReport = (
  ...
  return useApi<ViewReportResponse>(
    ...
    payload,
    {
      queryKey: ["integrity-view-report", payload?.doc_id || "", payload?.package_name || ""] as const,
      enabled,
      refetchOnMount: true,
    }
  );
...
export const useEditReport = (
  ...
  return useApi<EditReportResponse>(
    ...
    payload,
    {
      queryKey: ["integrity-edit-report", payload?.doc_id || "", payload?.package_name || ""] as const,
      enabled,
    }
  );
};
...
export const useUpdateReportStatus = (
  ...
  return useApi<StatusUpdateResponse>(
    ...
    payload,
    {
      queryKey: ["integrity-update-report-status", payload?.id?.toString() || "0", payload?.status || ""] as const,
      enabled,
      toast: {
        showToast: true,
...
export const useDeleteReport = (
  ...
  return useApi<DeleteReportResponse>(
    ...
    payload,
    {
      queryKey: ["integrity-delete-report", payload?.doc_id?.toString() || "0", payload?.package_name || ""] as const,
      enabled,
      toast: {
        showToast: true,
...
export const useCreateMailingList = (
  ...
  return useApi<CreateMailingListResponse>(
    ...
    payload,
    {
      queryKey: ["integrity-create-mailing-list", payload?.package_name || "", payload?.mailing_list_name || ""] as const,
      enabled,
      toast: {
        showToast: true,
...
export const useUpdateMailingList = (
  ...
  return useApi<UpdateMailingListResponse>(
    ...
    payload,
    {
      queryKey: ["integrity-update-mailing-list", payload?.mailing_list_id?.toString() || "0", payload?.package_name || ""] as const,
      enabled,
      toast: {
        showToast: true,
...
export const useUpdateMailingListStatus = (
  ...
  return useApi<MailingListStatusUpdateResponse>(
    ...
    payload,
    {
      queryKey: ["integrity-update-mailing-list-status", payload?.mailing_list_id?.toString() || "0", payload?.status || ""] as const,
      enabled,
      toast: {
        showToast: true,
...
export const useGetScheduleOccurrence = (
  ...
  return useApi<OccurrenceOption[]>(
    ...
    {
      queryKey: ["integrity-schedule-occurrence", packageName || ""] as const,
      enabled,
    }
  );
};
...
export const useGetDownloadOccurrence = (
  ...
  return useApi<OccurrenceOption[]>(
    ...
    packageName ? { package_name: packageName } : undefined,
    {
      queryKey: ["integrity-download-occurrence", packageName || ""] as const,
      enabled,
    }
  );
};
