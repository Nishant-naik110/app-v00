      ...
      <DialogContent className="sm:max-w-[800px] w-[95vw] max-h-[90vh] flex flex-col p-0">
        <DialogHeader className="px-6 py-4 border-b">
          <DialogTitle className="text-subBody font-semibold text-gray-900 dark:text-white">
            {isEditMode ? "Edit Rule Configuration" : "Rule Configuration"}
          </DialogTitle>
        </DialogHeader>
              ...
              >
                <div className="flex-1">
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      onUpdateRow?.(index, "configurationParameter", value || "")
                    }
                ...
                <div className="flex-1">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      onUpdateRow?.(index, "whitelistThreshold", e?.target?.value || "")
                    }
                    className="w-full"
                  />
                </div>
