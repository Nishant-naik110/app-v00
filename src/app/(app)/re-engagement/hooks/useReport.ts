...
// Type definitions - same as app-analytics but adapted for re-engagement
...
export interface DeliveryOptions {
  email?: {
    ...
    mail_id_list?: string[];
    click_to?: string[];
    click_mail_id_list?: string[];
    conversion_to?: string[];
    conversion_mail_id_list?: string[];
  };
  cloud?: {
    status?: boolean;
    bucket_name?: string;
...
export interface CreateReportPayload {
  click?: ReportPayload;
  conversion?: ReportPayload;
}

export interface ViewReportResponse {
  data?: {
    click?: ReportData;
    conversion?: ReportData;
  };
}
...
// API Base URL
const REPORT_API_BASE = process.env.NEXT_PUBLIC_APP_PERF + "reporting_tool/reengagement";
...
export const useGetCategories = (
  ...
  return useApi<CategoryOption[]>(
    ...
    {
      queryKey: ["reengagement-report-categories", packageName || ""] as const,
      enabled,
    }
  );
};
...
export const useGetTemplates = (
  ...
  return useApi<string[]>(
    ...
    {
      queryKey: ["reengagement-report-templates", packageName || "", category || ""] as const,
      enabled,
    }
  );
};
...
export const useGetTemplateFields = (
  ...
  return useApi<TemplateFieldsResponse>(
    ...
    {
      queryKey: ["reengagement-template-fields", template || "", category || "", packageName || "", reportType || ""] as const,
      enabled,
    }
  );
};
...
export const useGetDimensionFilters = (
  ...
  return useApi<FilterResponse>(
    ...
    {
      queryKey: ["reengagement-dimension-filters", dimensionId || "", packageName || "", categoryParam, reportType || "", search || ""] as const,
      enabled,
    }
  );
};
...
export const useCreateReport = (
  ...
  return useApi<CreateReportResponse>(
    ...
    payload,
    {
      queryKey: ["reengagement-create-report", payload ? JSON.stringify(payload) : ""] as const,
      enabled,
    }
  );
};
...
export const useViewReport = (
  ...
  return useApi<ViewReportResponse>(
    ...
    payload,
    {
      queryKey: ["reengagement-view-report", payload?.doc_id || "", payload?.package_name || ""] as const,
      enabled,
      refetchOnMount: true,
    }
  );
...
export const useEditReport = (
  ...
  return useApi<EditReportResponse>(
    ...
    payload,
    {
      queryKey: ["reengagement-edit-report", payload?.doc_id || "", payload?.package_name || ""] as const,
      enabled,
    }
  );
};
...
export const useUpdateReportStatus = (
  ...
  return useApi<StatusUpdateResponse>(
    ...
    payload,
    {
      queryKey: ["reengagement-update-report-status", payload?.id?.toString() || "0", payload?.status || "", payload?.package_name || ""] as const,
      enabled,
      toast: {
        showToast: true,
...
export const useDeleteReport = (
  ...
  return useApi<DeleteReportResponse>(
    ...
    payload,
    {
      queryKey: ["reengagement-delete-report", payload?.doc_id?.toString() || "0", payload?.package_name || ""] as const,
      enabled,
      toast: {
        showToast: true,
...
export const useCreateMailingList = (
  ...
  return useApi<CreateMailingListResponse>(
    ...
    payload,
    {
      queryKey: ["reengagement-create-mailing-list", payload?.package_name || "", payload?.mailing_list_name || ""] as const,
      enabled,
      toast: {
        showToast: true,
...
export const useUpdateMailingList = (
  ...
  return useApi<UpdateMailingListResponse>(
    ...
    payload,
    {
      queryKey: ["reengagement-update-mailing-list", payload?.mailing_list_id?.toString() || "0", payload?.package_name || ""] as const,
      enabled,
      toast: {
        showToast: true,
...
export const useUpdateMailingListStatus = (
  ...
  return useApi<MailingListStatusUpdateResponse>(
    ...
    payload,
    {
      queryKey: ["reengagement-update-mailing-list-status", payload?.mailing_list_id?.toString() || "0", payload?.status || ""] as const,
      enabled,
      toast: {
        showToast: true,
...
export const useGetMailingListList = (
  ...
  return useApi<MailingListListResponse>(
    ...
    {
      queryKey: [
        "reengagement-mailing-list-list",
        payload?.package_name || "",
...
export const useGetScheduleOccurrence = (
  ...
  return useApi<OccurrenceOption[]>(
    ...
    {
      queryKey: ["reengagement-schedule-occurrence", packageName || ""] as const,
      enabled,
    }
  );
};
...
export const useGetDownloadOccurrence = (
  ...
  return useApi<OccurrenceOption[]>(
    ...
    packageName ? { package_name: packageName } : undefined,
    {
      queryKey: ["reengagement-download-occurrence", packageName || ""] as const,
      enabled,
    }
  );
};
